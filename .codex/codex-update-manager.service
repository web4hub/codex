...
## Appshots
- [Appshots](https://learn.chatgpt.com/docs/appshots.md): Give ChatGPT context from apps on macOS and Windows
...
- [Analytics API](https://learn.chatgpt.com/docs/enterprise/analytics-api.md): Understand aggregated workspace reporting and Analytics API access
...
- [Deploy the Windows app](https://learn.chatgpt.com/docs/enterprise/windows-deployment.md): Install the ChatGPT desktop app with Intune, SCCM, another management tool, or a user installer
...
- [Managed configuration](https://learn.chatgpt.com/docs/enterprise/managed-configuration.md): Distribute configuration defaults and enforce requirements across supported local clients
...
- [Usage Insights for ChatGPT Work in Codex](https://learn.chatgpt.com/docs/enterprise/usage-insights.md): Understand usage and credit consumption across ChatGPT Work and Codex, and assess the value of your team's workflows
...
## Linux
- [ChatGPT desktop app for Linux](https://learn.chatgpt.com/docs/linux/linux-app.md): Install and update ChatGPT on supported Ubuntu, Debian, Fedora, and Arch Linux desktop distributions
...
## Mcp Server
- [Codex MCP server removal](https://learn.chatgpt.com/docs/mcp-server.md): Migrate from the removed Codex MCP server to the app server
...
## Pets
- [Pets](https://learn.chatgpt.com/docs/pets.md): Choose a companion, start chats from your desktop, and follow activity
